...
import { ChainSlicerGame } from './games/chain-slicer/ChainSlicerGame';

const GAME_ID = 'chain-slicer';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Chain Slicer';
const GAME_TAGLINE = import.meta.env.VITE_GAME_TAGLINE || 'Geometry puzzle game verified by ZK proofs';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_CHAIN_SLICER_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
